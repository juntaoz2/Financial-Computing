...
public:	// Public functions
    ...
    EuropeanOption(double r_,double sig_, double K_, double T_, double U_, double b_,char *optType_ ): r(r_), sig(sig_), K(K_), T(T_), U(U_), b(b_), optType(optType_) {}; //const constructor
